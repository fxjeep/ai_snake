...
public static class PropertyXpsHelper
{
    public static void GenerateXpsDocument(string outputXpsPath, string[] lines, PrintLayoutSettings settings, int sideFontSize = 12)
    {
